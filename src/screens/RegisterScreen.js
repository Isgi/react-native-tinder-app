      ...
      {({ handleChange, handleBlur, handleSubmit, values }) => (
        <ScrollView pagingEnabled horizontal scrollEnabled={false} ref={scrollRef} showsHorizontalScrollIndicator={false}>
          ...
          <View style={{ width: screenWidth, paddingHorizontal: 20 }}>
            ...
            <TouchableOpacity style={styles.secondaryButton} onPress={() => props.navigation.push('Login')}>
          ...
          <View style={{ width: screenWidth, paddingHorizontal: 20  }}>
            ...
            <TextInput
              ...
              style={[styles.textInput, { backgroundColor: theme.colors.background}]}
            />
            <Button mode="contained" onPress={() => scrollRef.current.scrollTo({ x: screenWidth * 2 })}>Continue</Button>
            <TouchableOpacity style={styles.secondaryButton} onPress={() => scrollRef.current.scrollTo({ x: 0 })}>
              <Text>Back</Text>
            </TouchableOpacity>
          </View>
          {/** third page */}
          <View style={{ width: screenWidth, paddingHorizontal: 20  }}>
            ...
            <TouchableOpacity style={styles.secondaryButton} onPress={() => scrollRef.current.scrollTo({ x: screenWidth })}>
              <Text>Back</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
